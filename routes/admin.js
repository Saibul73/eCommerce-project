...
router.get(
  ...
  adminController.renderaddcategory
);
router.post(
  "/createcategory",
  session.adminSession,
...
router.get(
  "/add-Product",
  session.adminSession,
  adminController.renderaddProduct
);
router.post(
  "/add-Product",
  session.adminSession,
...
router.get(
  "/edit-product/:id",
  session.adminSession,
  adminController.rendereditProduct
);
router.post(
  "/edit-product/:id",
  session.adminSession,
...
router.get(
  "/addBanner",
  session.adminSession,
  bannerController.renderaddbanner
);
router.post(
  "/addBanner",
  session.adminSession,
...
router.get(
  "/viewEditBanner/:id",
  session.adminSession,
  bannerController.vieweditbanner
);
router.post(
  "/editBanner/:id",
  session.adminSession,
